...
gulp.task('clean', async () => del.sync([`${CURRENT_DEPLOYMENT_FOLDER}/assets`, `${CURRENT_DEPLOYMENT_FOLDER}/index.html`]));

gulp.task('ci-after-build', async () => del.sync([`!${CURRENT_DEPLOYMENT_FOLDER}/assets`, `!${CURRENT_DEPLOYMENT_FOLDER}/index.html`]));
